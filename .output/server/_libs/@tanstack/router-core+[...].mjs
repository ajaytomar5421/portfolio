  ...
  : typeof window != "undefined"
    ...
    : typeof self != "undefined"
      ...
      : typeof globalthis_default != "undefined" &&
        Object.defineProperty(globalthis_default, L$1, {
          value: U,
          configurable: !0,
          writable: !1,
          enumerable: !1,
...
async function Dr(e, r, t) {
  ...
  return (
    C in t &&
      (a.push(I(e.base, C)), s.push(Ue(rr(e.base), await N$1(e, r, $e(t))))),
    v$1 in t &&
      (a.push(I(e.base, v$1)), s.push(je(tr(e.base), await N$1(e, r, Qe(t))))),
...
function fo(e, r, t) {
  ...
  if (n) {
    ...
    for (let s = 0, i = n.length; s < i; s++) {
      let u = n[s];
      if (u.tag === a)
        return b(e, t.i, u.deserialize(t.s, new Fr(e, r), { id: t.i }));
    }
  }
  throw new X(t.c);
}
...
function Qt(e, r, t, n) {
  return t
    ? F(e.base, t)
      ? (w$1(e.base, r), Ne(e, r, n, m$1(e, t.i)), "")
      : f$1(e, t)
    : "";
}
function jo(e, r) {
...
function Zr(e, r, t) {
  ...
  return (
    ...
    v$1 in t &&
      (a.push(I(e.base, v$1)),
      s.push(je(tr(e.base), E$1(e, r, e.type === 1 ? re() : Qe(t))))),
    P$1 in t && (a.push(I(e.base, P$1)), s.push($$1(t[P$1]))),
    R in t && (a.push(I(e.base, R)), s.push(t[R] ? H : J)),
    {
      k: a,
...
function _a(e, r, t, n) {
  let a = zr(e.base, {});
  return (
    e.type === 2 && (Qr(e), n.then(ha.bind(e, a, r), za.bind(e, a, r))),
    zt(e.base, t, a)
  );
}
function ka(e, r, t, n, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    ...
    if (u.parse.sync && u.test(n))
      return ce(t, u.tag, u.parse.sync(n, new Kr(e, r), { id: t }));
  }
  return o$1;
}
