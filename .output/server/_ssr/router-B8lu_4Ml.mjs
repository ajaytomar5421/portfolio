...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B8lu_4Ml.js
  ...
  head: () => ({
    meta: [
      ...
      { title: "Ajay Tomar — Full Stack Java & React Developer" },
      {
        name: "description",
        content:
          "Portfolio of Ajay Tomar — aspiring Full Stack Java Developer building modern web apps with Spring Boot, React, and REST APIs.",
      },
      {
        name: "author",
        content: "Ajay Tomar",
      ...
      },
      {
        ...
        content:
          "Portfolio of Ajay Tomar — Java, Spring Boot, React, and REST API developer based in Noida, India.",
      },
      {
        property: "og:type",
        content: "website",
...
var $$splitComponentImporter = () => import("./routes-DkTXJEdZ.mjs");
